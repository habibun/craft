...
insert  into `issue_line`(`id`,`issue_id`,`product_id`,`quantity`,`purpose`,`comment`) values (1,1,6,1.0000,'jony','this is a test'),(2,2,2,1.0000,'azad',''),(3,3,7,1.0000,'harun',''),(4,4,5,1.0000,'eon group','for all '),(5,5,5,1.0000,'eongroup','this is a test'),(6,6,3,3.0000,'azad,mamun,rony',''),(7,7,4,1.0000,'yousuf',''),(8,8,6,1.0000,'new','sdfsdf'),(9,9,6,1.0000,'rag','');
