...
insert  into `issue_line`(`id`,`issue_id`,`product_id`,`quantity`,`comment`) values (1,1,6,1.0000,'for mamun'),(2,2,2,1.0000,'jony'),(3,2,7,1.0000,'raju'),(4,2,3,1.0000,'zahed'),(5,3,1,1.0000,'dfsdf'),(6,3,5,1.0000,NULL);
...
insert  into `purchase_line`(`id`,`product_id`,`purchase_id`,`quantity`,`price`) values (1,6,1,1.00,35000.00),(2,2,2,1.00,400.00),(3,1,3,1.00,300.00),(4,5,3,1.00,300.00),(5,7,4,1.00,30000.00),(6,3,3,1.00,3000.00),(7,2,5,1.00,200.00),(8,5,6,1.00,3000.00),(9,3,7,1.00,1000.00),(10,1,7,1.00,300.00);
